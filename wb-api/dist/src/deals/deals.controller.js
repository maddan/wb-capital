...
let DealsController = class DealsController {
    ...
    create(dto) { return this.deals.create(dto); }
    findAll(q) { return this.deals.findAll(q); }
    findOne(id) { return this.deals.findOne(id); }
};
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [dto_1.QueryDealsDto]),
    __metadata("design:returntype", void 0)
